...
// TO DO
function addTheValues(input1, input2) {
    if (isNaN(input1) || isNaN(input2)){
        addToPage("One of the parameters is not a number, when added they equal " + input1 + " " + input2);
    }
    else {
        addToPage("Both of the parameters are numbers, when added they equal " + (input1 + input2));
    }
}
...
function scopeExample() {
    let localVariable = "This is a local variable the scopeExample() function";
...
//let doubleMyNumberArrow = (number) => {return number *= 2};
